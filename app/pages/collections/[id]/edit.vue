...
onMounted(async () => {
  try {
    ...
    const c = collectionStore.collection;
    if (!c) {
...
async function onSubmit({ valid, values }) {
  ...
  try {
    ...
    await collectionStore.updateCollection(id, formData);
...
<template>
  <div>
    ...
    <div class="flex items-center gap-3 mb-6">
      ...
      <h1 class="text-2xl font-bold text-slate-900">Edit Collection</h1>
    </div>
    ...
    >
      ...
      <div class="bg-white rounded-lg border border-slate-200 p-6 mb-6">
        ...
        >
          ...
          <template #content>
            <div v-if="image || existingImage" class="flex flex-wrap gap-4 mt-2">
              ...
              <div v-if="existingImage && !image" class="relative">
                ...
                />
                <span class="block text-xs text-slate-500 mt-1 truncate max-w-28">

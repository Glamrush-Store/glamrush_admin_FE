...
async function onSubmit({ valid, values }) {
  ...
  try {
    ...
    navigateTo(`/vendors/${response.data.id}`);
  } catch (e) {
...
<template>
  <div>
    ...
    <div class="flex items-center gap-3 mb-6">
      ...
      <h1 class="text-2xl font-bold text-slate-900">Create Vendor</h1>
    </div>
      ...
      <div class="bg-white rounded-lg border border-slate-200 p-6 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="flex flex-col gap-1">
            ...
            <InputText v-model="addressLine1" placeholder="Street address" fluid />
          </div>

          <!-- Address Line 2 -->
          <div class="flex flex-col gap-1">
            <label class="text-sm font-medium text-slate-700">Address Line 2</label>
            <InputText v-model="addressLine2" placeholder="Apt, suite, etc." fluid />
          </div>
          ...
          <div class="flex flex-col gap-1">
            ...
            <InputText v-model="postalCode" placeholder="Postal code" fluid />
          </div>
